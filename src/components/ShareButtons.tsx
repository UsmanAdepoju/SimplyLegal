...
export default function ShareButtons({ law }: ShareButtonsProps) {
  const shareText = `📜 *${law.title}*\n\n${law.summary}\n\n🔑 Key Points:\n${law.keyPoints.map((p, i) => `${i + 1}. ${p}`).join('\n')}\n\n📖 Source: ${law.source}\n\n👉 Learn more about Nigerian laws at SimplyLegal`;

  const tweetText = `📜 ${law.title}\n\n${law.summary}\n\n#NigerianLaw #KnowYourRights #SimplyLegal`;
  ...
  return (
    <div className="mt-6 bg-white rounded-lg shadow p-4">
      ...
      <p className="text-sm text-gray-600 mb-4">
        Help others understand their rights by sharing this simplified explanation.
      </p>
